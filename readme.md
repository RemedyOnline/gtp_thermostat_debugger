...
This web application allows you to manage Air Conditioner (AC) schedules for different rooms. Follow the steps below to get started:

## ➕ Adding a Room

- Locate the “Add Room” button on top of the homepage.
- Enter a unique room name (e.g., Meeting Room, Office 1, Balcony, etc.).
